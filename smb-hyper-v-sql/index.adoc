...
.相關資訊
有關 ONTAP 技術及其與外部服務互動的更多資訊，請參閱以下技術報告（TR）：** https://www.netapp.com/pdf.html?item=/media/16334-tr-4172.pdf["NetApp技術報告4172：Microsoft Hyper-V over SMB 3.0 with ONTAP NetApp最佳實務做法"^]
