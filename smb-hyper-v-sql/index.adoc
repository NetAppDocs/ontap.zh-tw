...
summary: ONTAP 功能可讓您透過 SMB 協定為兩個 Microsoft 應用程式（Microsoft Hyper-V 和 Microsoft SQL Server）啟用不中斷營運。 
---
...
.相關資訊
有關 ONTAP 技術及其與外部服務互動的更多資訊，請參閱以下技術報告（TR）：** https://www.netapp.com/pdf.html?item=/media/16334-tr-4172pdf.pdf["NetApp技術報告4172：Microsoft Hyper-V over SMB 3.0 with ONTAP NetApp最佳實務做法"^]
