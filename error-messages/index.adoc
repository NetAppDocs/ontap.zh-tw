...
您可以在本頁的「更多資源」下找到EMS事件目錄： link:https://mysupport.netapp.com/documentation/productlibrary/index.html?productID=62286["產品庫ONTAP"^]。請參閱 xref:convert-ems-routing-to-notifications-task.html[將舊版事件路由型路由傳送轉換成事件通知] 如需如何執行通知型模型轉換的詳細資訊、您也可以參閱 link:https://docs.netapp.com/us-en/ontap-ems-9121/["EMS參考資料"^]。
