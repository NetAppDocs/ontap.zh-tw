...
您可以在此頁面上找到最新 ONTAP 9 版本的醒目提示新功能、或使用側欄瀏覽至特定的 ONTAP 9 版本、以瞭解最新 ONTAP 版本的所有增強功能。
...
ONTAP 9.14.1 在 FabricPool 、防勒索軟體保護、 OAuth 等領域提供全新且增強的功能。如需新功能與增強功能的完整清單、請參閱 xref:9141-reference.adoc[ONTAP 9.14.1 的新功能]。
...
+
將中繼資料標記新增至磁碟區和叢集、隨著資料從內部部署移至雲端並進行反向作業。
...
ONTAP 9.12.1 在安全強化、保留、效能等領域提供全新且增強的功能。如需新功能與增強功能的完整清單、請參閱 xref:9121.adoc[ONTAP 9.12.1 的新功能]。
...
ONTAP 9.10.1 在安全強化、效能分析、 NVMe 傳輸協定支援和物件儲存備份選項等領域提供全新且增強的功能。如需新功能與增強功能的完整清單、請參閱 xref:91-1-reference.adoc[ONTAP 9.10.1 的新功能]。
