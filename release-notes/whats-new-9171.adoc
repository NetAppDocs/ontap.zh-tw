...
| 更新 | 說明 
 ...
 a| 
xref:../anti-ransomware/index.html[額外的 Hypervisor 支援]
 a| 
從 ONTAP 9.17.1P5 開始、自主勒索軟體保護支援 Hyper-V、KVM 和 OpenStack 虛擬機器管理程式。



 a| 
xref:../anti-ransomware/index.html[自主勒索軟體防護快照更新]
 a| 
ONTAP 對 ARP/AI 快照進行了多項更新。
