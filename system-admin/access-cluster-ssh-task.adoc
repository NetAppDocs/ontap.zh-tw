...
* 從 ONTAP 9.19.1 開始，管理者可以使用 link:https://docs.netapp.com/us-en/ontap-cli/security-ssh-publickey-show.html["security ssh publickey show -vserver  -host-key-algorithm  命令"^] 來檢視 ONTAP 主機金鑰指紋。這可讓管理者驗證此指紋是否與 ONTAP 中儲存的指紋相符。
