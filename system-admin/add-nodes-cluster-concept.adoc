...
[NOTE]
====
如需使用設定 GUI 設定叢集的詳細資訊，請參閱link:https://docs.netapp.com/us-en/ontap/manage-nodes-sm-task.html["系統管理員"]線上說明。如link:https://docs.netapp.com/us-en/ontap-cli/cluster-setup.html["指令參考資料ONTAP"^]需詳細 `cluster setup`資訊，請參閱。
...
.相關資訊
link:../upgrade/concept_mixed_version_requirements.html#mixed-version-clusters-supported-for-ontap-software-upgrades["混合版本 ONTAP 叢集"]
