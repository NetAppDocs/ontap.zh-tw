...
summary: 您可以使用 System Manager 安裝 NetApp 授權檔案和授權金鑰，這是安裝 NLF 的首選方法，或者您也可以使用 ONTAP CLI 安裝授權金鑰。在 ONTAP 9.10.1 及更新版本中，功能透過 NetApp 授權檔案啟用，而在 ONTAP 9.10.1 之前的版本中，ONTAP 功能透過授權金鑰啟用。 
---
