...
====
如果您想要停用 AutoSupport OnDemand 、但仍保持啟用 AutoSupport 、請使用命令： https://docs.netapp.com/us-en/ontap-cli-9121/system-node-autosupport-modify.html#parameters[`system node autosupport modify -ondemand-state disable`]。
