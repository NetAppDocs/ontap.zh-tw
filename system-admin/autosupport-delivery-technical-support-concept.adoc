...
====
如果您想要停用 AutoSupport OnDemand ，但仍保持啟用 AutoSupport ，請使用命令： link:https://docs 。 NetApp 。 ONTAP － AutoSupport － modife.html#parameters[`system node autosupport modify -ondemand-state disable`^ 。
