...
.步驟
您可以下載 ONTAP One 授權檔案，適用於具有現有 NetApp 授權檔案套件的系統，以及在執行 ONTAP 9.10.1 及更新版本的系統上已將 28 字元授權金鑰轉換為 NetApp 授權檔案的系統。您也可以付費將系統從 ONTAP Base 升級至 ONTAP One。如需下載 NetApp 授權檔案的詳細資訊，請參閱知識庫文章 link:https://kb.netapp.com/nss/Licensing/How_to_download_NLF_licenses_from_the_NetApp_Support_Site["如何從 NetApp 支援網站下載 NLF 授權"^]。
