...
了解更多關於  `help` 指令選項可用於 SP 和 BMC link:online-help-at-sp-bmc-cli-task.html["在 ONTAP SP / BMC CLI 中檢視說明資訊"]。

深入瞭解 link:bmc-cli-commands-reference.html["ONTAP 基礎板管理控制器支援的 CLI 命令"] 中對應的 ONTAP BMC CLI。
