...
.關於這項工作
此程序適用於 FAS 、 AFF 和目前的 ASA 系統。如果您有 ASA R2 系統（ ASA A1K 、 ASA A70 或 ASA A90 ）、請遵循link:https://docs.netapp.com/us-en/asa-r2/manage-data/modify-storage-units.html["這些步驟"^]以增加儲存單元的大小。ASA R2 系統提供專為僅限 SAN 的客戶所提供的簡化 ONTAP 體驗。
...
深入瞭解 ONTAP 命令參照中的連結： https://docs 。 NetApp 。 ONTAP - CLI/lun-resize 。 html#description[`lun resize`^] 命令。
