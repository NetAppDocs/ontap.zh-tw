...
.關於這項工作
此程序適用於 FAS 、 AFF 和目前的 ASA 系統。如果您擁有 ASA r2 系統（ASA A1K、ASA A90、ASA A70、ASA A50、ASA A30、ASA A20 或 ASA C30），請遵循link:https://docs.netapp.com/us-en/asa-r2/manage-data/modify-storage-units.html["這些步驟"^]增加儲存單元的大小。ASA R2 系統提供專為僅限 SAN 的客戶所提供的簡化 ONTAP 體驗。
