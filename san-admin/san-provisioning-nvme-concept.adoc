...
summary: 從 ONTAP 9.4 開始，SAN 環境支援 NVMe FC。NVMe FC 使儲存管理員能夠配置命名空間和子系統，然後將命名空間對應到子系統，類似於 FC 和 iSCSI 中 LUN 的配置和對應到 igroup 的方式。 
---
= 採用NVMe的SAN資源配置
:allow-uri-read: 
:icons: font
...
.相關資訊
https://www.netapp.com/pdf.html?item=/media/10681-tr4684.pdf["NetApp技術報告4684：實作及設定採用NVMe / FC的現代化SAN"^]
