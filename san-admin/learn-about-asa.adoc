...
summary: NetApp 全快閃 SAN 陣列從 ONTAP 9.7 開始提供。ASA 是基於成熟的 AFF NetApp 平台所建置的全快閃 SAN 專用解決方案。 
---
...
* link:https://www.netapp.com/pdf.html?item=/media/10680-tr4080.pdf["NetApp 技術報告 4080 ：現代 SAN 的最佳實務做法"^]
