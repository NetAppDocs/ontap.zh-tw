...
summary: 您可以將韌體更新套用至叢集中受支援的裝置，例如磁碟、磁碟櫃、服務處理器或 Baseboard Management Controller。 
---
= 手動更新韌體
:hardbreaks:
:toclevels: 1
...
[role="lead"]
從 ONTAP 9.9.1 開始，如果您已註冊 link:https://docs.netapp.com/us-en/active-iq/["數位顧問"^]，則可以在 System Manager 中收到警示，該警示會在叢集上受支援的裝置（例如磁碟、磁碟櫃、服務處理器（SP）或基板管理控制器（BMC））的韌體更新待處理時通知您。

如果您正在執行 ONTAP 9.8 或尚未註冊 Digital Advisor，請前往 NetApp 支援網站下載韌體更新。
...
.步驟
請根據您的 ONTAP 版本以及您是否已在 Digital Advisor 註冊，遵循相應的程序。
