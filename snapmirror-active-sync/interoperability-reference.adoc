...
從 ONTAP 9.19.1 開始，ARP/AI 支援參與 SnapMirror 主動同步 SAN 關係的主要 Volume。如需更多資訊，請參閱 link:../anti-ransomware/support-arpai.html#arp-ai-and-virtual-machines["自主勒索軟體保護的使用案例和考量"]。
