...
.關於這項工作
此程序適用於 link:https://docs.netapp.com/us-en/ontap-systems-family/index.html["AFF， ASA FAS"^] 和 link:https://docs.netapp.com/us-en/ontap-afx/index.html["AFX 系統"^]。如果您擁有ASA r2 系統（ASA A1K、 ASA A90、 ASA A70、 ASA A50、 ASA A30、 ASA A20 或ASA C30），請依照下列步驟操作。 link:https://docs.netapp.com/us-en/asa-r2/install-setup/initialize-ontap-cluster.html["這些步驟"^] 使用系統管理器設定ONTAP集群。ASA r2 系統為僅使用 SAN 的客戶提供簡化的ONTAP體驗。
