...
----
+
如需完整的命令語法、請參閱 link:https://docs.netapp.com/us-en/ontap-cli-9131//snapmirror-quiesce.html["手冊頁"^]。
...
----
+
如需完整的命令語法、請參閱 link:https://docs.netapp.com/us-en/ontap-cli-9131//snapmirror-break.html["手冊頁"^]。
...
----
+
如需完整的命令語法、請參閱 link:https://docs.netapp.com/us-en/ontap-cli-9131//snapmirror-delete.html["手冊頁"^]。
