...
+
如果您的系統是在 2019 年 6 月之前購買，且隨附 Premium 或 Flash Bundle，您可以從 NetApp 支援網站下載 NetApp 授權金鑰，以取得所需的 SnapMirror 同步授權： https://mysupport.netapp.com/NOW/knowledge/docs/olio/guides/master_lickey/["授權金鑰"^]。
