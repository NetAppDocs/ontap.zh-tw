...
* link:../data-protection/exclude-lifs-svm-replication-task.html["從SVM複寫中排除LIF及相關的網路設定"]
* link:../data-protection/exclude-network-name-service-svm-replication-task.html["從 SVM 組態中排除網路、名稱服務及其他設定"]
