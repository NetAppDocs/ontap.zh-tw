...
NOTE: 您可以使用 `security login role config modify` 用於修改與指定角色相關聯之帳戶的密碼規則的命令。如需詳細資訊、請參閱 link:https://docs.netapp.com/us-en/ontap-cli/security-login-role-config-modify.html["命令參考資料"^]。
