...
. 選取任何數字以檢視有關某一類別憑證的詳細資料、或選取 image:icon_arrow.gif["箭頭圖示"] 以開啟包含所有類別資訊的 * 憑證 * 頁面。清單會顯示整個叢集的資訊。如果您只想顯示特定儲存VM的資訊、請執行下列步驟：
+
.. 選取 * 儲存 > 儲存 VM* 。
.. 選取儲存VM。
.. 切換至 * 設定 * 索引標籤。
...
. 選擇。 image:icon_add_blue_bg.gif["新增圖示"]
...
. 檢視*信任的憑證授權單位*索引標籤。請參閱 <<檢視憑證資訊>>。
. 選取信任的憑證授權單位名稱。
. 選取 image:icon_kabob.gif["功能表選項圖示"] 名稱旁邊的，然後選取 * 刪除 * 。
...
. 檢視*信任的憑證授權單位*索引標籤。請參閱 <<檢視憑證資訊>>。
. 選取信任的憑證授權單位名稱。
. 選取 image:icon_kabob.gif["功能表選項圖示"] 憑證名稱旁邊的 * 更新 * 。
...
. 檢視*用戶端/伺服器憑證*索引標籤。請參閱 <<檢視憑證資訊>>。
. 選取用戶端 / 伺服器憑證的名稱。
. 選取 image:icon_kabob.gif["功能表選項圖示"] 名稱旁邊的，然後按一下 * 刪除 * 。
...
. 檢視*用戶端/伺服器憑證*索引標籤。   請參閱 <<檢視憑證資訊>>。
. 選取用戶端 / 伺服器憑證的名稱。
. 選取 image:icon_kabob.gif["功能表選項圖示"] 名稱旁邊的、然後按一下 * 更新 * 。
...
. 查看*本地證書頒發機構*選項卡。   請參閱 <<檢視憑證資訊>>。
. 選取本機憑證授權單位的名稱。
. 選擇 image:icon_kabob.gif["功能表選項圖示"] 名稱旁邊的，然後 * 簽署證書 * 。
. 填寫*簽署憑證簽署要求*表單。
+
...
. 選取本機憑證授權單位的名稱。
. 選擇 image:icon_kabob.gif["功能表選項圖示"] 名稱旁邊的 * 刪除 * 。
