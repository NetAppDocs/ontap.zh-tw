...
summary: 從 ONTAP 9.14 版本開始，您可以選擇使用開放授權 （OAuth 2.0） 框架來控制對 ONTAP 叢集的存取。您可以使用任何 ONTAP 管理介面來設定此功能，包括 ONTAP CLI、System Manager 和 ONTAP REST API。但是，OAuth 2.0 授權和存取控制決策只能在用戶端使用 ONTAP REST API 存取 ONTAP 時生效。 
---
...
[role="lead"]
從 ONTAP 9.14 版本開始，您可以選擇使用開放授權 （OAuth 2.0） 框架來控制對 ONTAP 叢集的存取。您可以使用任何 ONTAP 管理介面來設定此功能，包括 ONTAP CLI、System Manager 和 ONTAP REST API。但是，OAuth 2.0 授權和存取控制決策只能在用戶端使用 ONTAP REST API 存取 ONTAP 時生效。
