...
NOTE: 這些限制適用於目前的 ASA 系統。如果您有 ASA r2 系統（ASA A1K、ASA A90、ASA A70、ASA A50、ASA A30、ASA A20 或 ASA C30），請參閱link:https://docs.netapp.com/us-en/asa-r2/manage-data/storage-limits.html["ASA R2 系統儲存限制"] 。
