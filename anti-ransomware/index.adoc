...
雖然 ONTAP 包含 FPolicy 、 Snapshot 複本、 SnapLock 和 Active IQ 數位顧問（也稱為數位顧問）等功能、可協助防範勒索軟體、但下列資訊著重於具備機器學習能力的 ARP 隨裝即用功能。
...
* link:../data-protection/restore-contents-volume-snapshot-task.html["從Snapshot複本恢復（System Manager）"]
