...
summary: 透過自動或手動更新 ARP/AI 安全性套件（獨立於 ONTAP 版本節奏），讓 ARP/AI 保護與最新的勒索軟體威脅保持同步。 
---
...
NOTE: ARP（ONTAP 9.10.1 至 9.15.1）不支援自動安全性模型更新。安全性偵測功能僅透過 ONTAP 軟體升級進行更新。如果您執行的是 ONTAP 9.15.1 或更早版本，請參閱 link:index.html["了解自主勒索軟體防護"]。
...
NOTE: 請務必安裝比目前版本更新的 ARP/AI 更新，以避免 ARP/AI 意外降級。
