...
如需 ARP 組態選項（包括預設值）的詳細資訊、請參閱 link:https://docs.netapp.com/us-en/ontap-cli-9141//security-anti-ransomware-volume-auto-switch-to-enable-mode-show.html["指令參考資料ONTAP"^]。
...
. 瀏覽至 * 設定 * 索引標籤。在 * 安全 * 下、找到 ** 防勒索軟體 ** 磚、然後選取 image:icon_pencil.gif["筆圖示"]
