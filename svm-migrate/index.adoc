...
| SVM MetroCluster | 不支援 | 雖然 SVM 移轉不支援 MetroCluster SVM 移轉、但您可能可以使用 SnapMirror 非同步複寫至 link:https://www.netapp.com/media/83785-tr-4966.pdf["在 MetroCluster 組態中移轉 SVM"]。 
