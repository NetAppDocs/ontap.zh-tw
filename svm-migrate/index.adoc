...
* 來源叢集和目的地叢集必須同步 SnapMirror link:https://docs.netapp.com/us-en/ontap/system-admin/install-license-task.html["已安裝授權"]。本授權隨附於 link:https://docs.netapp.com/us-en/ontap/system-admin/manage-licenses-concept.html#licenses-included-with-ontap-one["ONTAP One"]。
...
| SnapMirror Cloud 關係 | ONTAP 9.12.1 | 從 ONTAP 9.12.1 開始、當您移轉具有 SnapMirror 雲端關係的 SVM 時、目的地叢集必須具有 link:https://docs.netapp.com/us-en/ontap/data-protection/snapmirror-licensing-concept.html#snapmirror-cloud-license["SnapMirror Cloud授權"] 而且它必須有足夠的可用容量、才能支援將鏡射磁碟區中的容量移至雲端。 
