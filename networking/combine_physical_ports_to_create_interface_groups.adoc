...
如link:https://docs.netapp.com/us-en/ontap-cli/network-port-ifgrp-add-port.html["指令參考資料ONTAP"^]需詳細 `network port ifgrp add-port`資訊，請參閱。如link:https://docs.netapp.com/us-en/ontap-cli/network-port-ifgrp-add-port.html["指令參考資料ONTAP"^]需詳細 `network port ifgrp add-port`資訊，請參閱。
...
如link:https://docs.netapp.com/us-en/ontap-cli/network-port-ifgrp-delete.html["指令參考資料ONTAP"^]需詳細 `network port ifgrp delete`資訊，請參閱。如link:https://docs.netapp.com/us-en/ontap-cli/network-port-ifgrp-delete.html["指令參考資料ONTAP"^]需詳細 `network port ifgrp delete`資訊，請參閱。
