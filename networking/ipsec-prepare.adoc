...
|===
如需 ONTAP REST API 的詳細資訊， https://docs.netapp.com/us-en/ontap-automation/whats-new.html["更新功能ONTAP"^]請參閱 ONTAP 自動化文件網站上的。您也應該檢閱 ONTAP https://docs.netapp.com/us-en/ontap-automation/reference/api_reference.html["API 參考資料"^] 文件，瞭解有關 IPsec 端點的詳細資訊。
