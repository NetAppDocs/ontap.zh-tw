...
|===
深入瞭解link:https://docs.netapp.com/us-en/ontap-cli/network-subnet-add-ranges.html["網路子網路新增範圍"^]此程序中所述的命令或link:https://docs.netapp.com/us-en/ontap-cli/network-subnet-remove-ranges.html["網路子網路移除範圍"^]命令。
