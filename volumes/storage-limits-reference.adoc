...
+
image:hardware-universe-products.png["Hardware Universe 產品功能表"]

. 選擇您的平台。
+
image:hardware-universe-platforms.png["Hardware Universe 平台功能表"]

. 選擇適當的 ONTAP 版本、然後選擇「顯示結果」 ** 。
+
image:hardware-universe-os-filter.png["Hardware Universe OS 篩選器功能表"]
