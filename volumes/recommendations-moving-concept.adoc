...
* 從ONTAP 9.15.1 開始，將磁碟區從 A400 系統移至 A70、A90 或 A1K 系統可能會導致讀取延遲問題增加。有關詳細資訊和建議措施，請參閱 link:https://kb.netapp.com/on-prem/ontap/Ontap_OS/FS_Issues/CONTAP-556247["NetApp知識庫：CONTAP-556247 - 磁碟區從 A400 遷移到 A70、A90 和 A1K 後壓縮/解壓縮速度緩慢"^]。
