...
summary: 繞過遍歷檢查是一項使用者權限，它決定使用者是否可以遍歷檔案路徑中的所有目錄，即使該使用者對要遍歷的目錄沒有權限。您應該了解允許或禁止繞過遍歷檢查會產生什麼影響，以及如何在儲存虛擬機器上為使用者設定繞過遍歷檢查。 
---
...
* xref:assign-privileges-concept.html[支援的權限清單]
