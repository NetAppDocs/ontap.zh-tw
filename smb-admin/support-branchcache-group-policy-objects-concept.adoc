...
summary: ONTAP BranchCache 提供 BranchCache 群組原則物件支援，可集中管理某些 BranchCache 組態參數。BranchCache 使用兩種 GPO，分別是 Hash Publication for BranchCache GPO 和 Hash Version Support for BranchCache GPO。 
---
