...
summary: 為了獲得基於 Kerberos 通訊的最強安全性，您可以在 SMB 伺服器上啟用 AES-256 和 AES-128 加密。預設情況下，在 SVM 上建立 SMB 伺服器時，Advanced Encryption Standard 加密處於停用狀態。您必須啟用 AES 加密才能利用其提供的強大安全性。 
---
