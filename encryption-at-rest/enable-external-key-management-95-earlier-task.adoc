...
NOTE: 在MetroCluster環境中，您必須在兩個叢集上執行此命令。詳細了解 `security key-manager setup`在link:https://docs.netapp.com/us-en/ontap-cli-9161/security-key-manager-setup.html["指令參考資料ONTAP"^]。
...
+
詳細了解此過程中所述的命令link:https://docs.netapp.com/us-en/ontap-cli-9161/security-key-manager-show-key-store.html["指令參考資料ONTAP"^]。
