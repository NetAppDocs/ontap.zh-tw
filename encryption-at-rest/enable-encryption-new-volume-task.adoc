...
|===
+
如需完整的命令語法、請參閱命令參考頁面以取得連結： https://docs.netapp.com/us-en/ontap-cli-9131/volume-create.html[`volume create`^]。
...
+
如需完整的命令語法、請參閱 link:https://docs.netapp.com/us-en/ontap-cli-9131/volume-show.html["命令參考資料"^]。
