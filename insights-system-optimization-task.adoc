...
.關於這項工作
此程序適用於 FAS 、 AFF 和目前的 ASA 系統。如果您有 ASA R2 系統（ ASA A1K ， ASA A90 ， ASA A70 ， ASA A50 ， ASA A30 或 ASA A20 ），請遵循以下步驟link:https://docs.netapp.com/us-en/asa-r2/monitor/view-insights.html["這些步驟"^]來檢視有助於最佳化系統的深入見解。ASA R2 系統提供專為僅限 SAN 的客戶所提供的簡化 ONTAP 體驗。
