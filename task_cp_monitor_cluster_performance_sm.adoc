...
---
= 了解如何使用 ONTAP System Manager 監控叢集效能
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
從 ONTAP 9.19.1 開始，SVM 管理員可以使用 ONTAP System Manager 中的專用 SVM 管理員儀表板來監控和管理自己的 SVM。如需詳細資訊，請參閱link:task-svm-admin-dashboard-sm.html["使用 System Manager 管理和監控 SVM"]。
