...
== ONTAP 9.18.1 及更高版本支援的功能

* xref:../performance-admin/adaptive-qos-policy-groups-task.html[嵌套 QoS 策略]支援以下對象對：
+
** SVM 和FlexGroup磁碟區包含在 SVM 中
** FlexGroup捲和卷內的 qtree
...
* xref:../anti-ransomware/index.html[自主勒索軟體保護] 適用於 FlexGroup Volume，包括以下支援的功能：
+
