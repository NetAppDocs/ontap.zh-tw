...
* 當您使用系統管理員建立FlexGroup區時， ONTAP會自動選擇建立FlexGroup磁碟區所需的本機層。
...
====
.相關資訊
https://www.netapp.com/pdf.html?item=/media/12385-tr4571.pdf["NetApp技術報告4571：NetApp FlexGroup 《最佳實務做法與實作指南》"^]
