...
link:fast-directory-delete-asynchronous-task.html#delete-directories-asynchronously["了解如何使用 ONTAP 從 FlexVol 和 FlexGroup 磁碟區中非同步刪除目錄"].
...
.步驟
. 從叢集 CLI 進入進階權限模式： `-privilege advanced`
