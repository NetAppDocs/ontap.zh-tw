...
link:tiering-policies-concept.html#what-happens-when-you-modify-a-volume-tiering-policy["修改磁碟區分層原則時會發生什麼情況？"]
...
** `none`
+
link:tiering-policies-concept.html["FabricPool 磁碟區分層原則"]
