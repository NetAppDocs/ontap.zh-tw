...
* 從內部部署 ONTAP 叢集分層到 Azure Blob Storage 時需要 link:install-license-aws-azure-ibm-task.html["不含授權FabricPool"]。
* 如果您使用的是 Cloud Volumes ONTAP 或 Azure NetApp Files 的 Azure Blob Storage，則不需要授權。
