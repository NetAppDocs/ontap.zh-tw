...
summary: 成功測試 NFS 客戶端存取後，您可以執行其他 NFS 組態或新增 SAN 存取。傳輸協定存取完成後，您應該保護儲存虛擬機器的根磁碟區。 
---
...
* https://www.netapp.com/pdf.html?item=/media/16398-tr-3580.pdf["NetApp技術報告3580：NFSv4增強功能與最佳實務做法指南Data ONTAP -實作"^]
+
...
* https://www.netapp.com/pdf.html?item=/media/16885-tr-4182.pdf["NetApp技術報告4182：乙太網路儲存設計考量與叢集Data ONTAP 式的最佳實務做法"^]
+
說明ONTAP 實作的環節、並提供常見的網路部署情境和最佳實務建議。

* https://www.netapp.com/pdf.html?item=/media/16328-tr-4668.pdf["NetApp技術報告4668：名稱服務最佳實務做法指南"^]
+
