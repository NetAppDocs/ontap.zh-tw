...
在使用SnapMirror Cloud功能之前、您應該在NetApp支援網站上產生SnapMirror Cloud API授權金鑰： link:https://mysupport.netapp.com/site/tools/snapmirror-cloud-api-key["產生SnapMirror Cloud API授權金鑰"^]
