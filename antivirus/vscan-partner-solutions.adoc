...
* link:https://docs.trellix.com/bundle/endpoint-security-storage-protection-2.3.x-product-guide/page/GUID-58044D4D-91E6-4F1C-892C-605783676063.html["NetApp 在 Trellix ePO 上的組態 - 本機託管端點 (trellix.com)"^]
...
| Trend Micro | link:https://docs.trendmicro.com/en-us/documentation/article/serverprotect-for-netapp-gsg-aspx-__architecture-cluster-2["Cluster-Mode 下的產品架構"^] | link:https://imt.netapp.com/matrix/["NetApp 互通性對照表工具"^] 


| Sentinel One  a| 
* link:https://www.sentinelone.com/platform/singularity-cloud-data-security/["SentinelOne 奇異性雲端資料安全性"^]
* link:https://www.sentinelone.com/resources/datasheets/threat-detection-for-netapp/["威脅偵測（適用於 NetApp）"^]
