...
NOTE: 您也可以將這些 LUN 的規格儲存到 Ansible Playbook 中。如需更多詳細資訊，請前往 link:https://docs.netapp.com/us-en/ontap/task_use_ansible_playbooks_add_edit_volumes_luns.html["使用「可執行教戰手冊」來新增或編輯磁碟區或LUN"^]。
