...
* 所有負載共用鏡射關係
+
如需有關刪除負載共用關係的詳細資訊，請參閱 link:https://kb.netapp.com/on-prem/ontap/DP/SnapMirror/SnapMirror-KBs/How_to_remove_a_load-sharing_LS_mirror_relationship["如何移除負載共享鏡射關係"]。
