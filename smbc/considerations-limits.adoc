...
SM - BC支援 xref:../data-protection/supported-deployment-config-concept.html[連出組態] 使用 `MirrorAllSnapshots` 政策、從ONTAP 功能9.11.1開始 `MirrorAndVault` 原則。搭配的SM至BC不支援連出組態 `XDPDefault` 原則。
