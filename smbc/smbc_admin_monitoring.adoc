...
在正常操作期間、應連接「中保」狀態。如果處於任何其他狀態、可能表示發生錯誤。您可以檢閱 link:https://docs.netapp.com/us-en/ontap-ems-9121/sm-mediator-events.html["事件管理系統（EMS）訊息"^] 以判斷錯誤及適當的修正行動。
...
....
請參閱 link:https://docs.netapp.com/us-en/ontap-ems-9121/smbc-pfo-events.html["EMS參考資料"^] 以瞭解事件訊息和修正行動。
...
Last Progress Update: -
  ...
  Error Reason codes: -
....
請參閱 link:https://docs.netapp.com/us-en/ontap-ems-9121/smbc-aufo-events.html["EMS參考資料"^] 以瞭解事件訊息及修正行動。
