...
如需ONTAP 更多有關靜態API的資訊、請參閱 https://["REST API參考文件ONTAP"]。
...
一致性群組快照 ONTAP REST API 可透過系統管理員的一致性群組介面及一致性群組 REST API 端點來管理。
...
[cols="3,1,1,1,1"]
|===
|  | ONTAP 9.13.1.12.9.11.9.11. | 零點9.12.1. ONTAP | 零點9.11.1. ONTAP | 零點9.10.1 ONTAP 
