...
[NOTE]
====
* 自 2025 年 6 月 15 日起，您無法安裝或升級至 ONTAP Mediator 1.8 和 1.9，因為代碼簽署驗證憑證已過期。請安裝或升級至 ONTAP Mediator 1.9.1。
...
----
. 使用相關的憑證來驗證 `ontap-mediator-1.9.1.sig.tsr`和 `ontap-mediator-1.9.1.tsr`檔案：
+
`openssl ts -verify`
