...
+
或者，您可以在 `./ontap-mediator-1.12.1/ontap-mediator-1.12.1 -y` 指令中使用 `--https-only` 選項來指定僅使用 HTTPS。
...
[NOTE]
====
若要在安裝期間跳過簽章檢查，請使用此命令： `./ontap-mediator-1.12.1/ontap-mediator-1.12.1 -y --skip-code-signature-check`
