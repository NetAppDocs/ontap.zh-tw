...
要安裝或升級 ONTAP Mediator，必須確保滿足所有先決條件。
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-6.png["六"]link:install-mediator-pkg-task.html["安裝 ONTAP Mediator"]
[role="quick-margin-para"]
