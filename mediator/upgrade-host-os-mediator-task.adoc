...
====
+
.SnapMirror Business Continuity 程序
[%collapsible]
====
對於 SnapMirror Business Continuity 、如果您在 /opt/NetApp 目錄外安裝 TLS 憑證、則不需要重新安裝。如果您使用的是預設產生的自我簽署憑證、或是將您的自訂憑證放入 /opt/NetApp 目錄、則您應該備份並還原它。
