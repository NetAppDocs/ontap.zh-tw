...
image::../media/namespace-architecture-with-single-branched-tree.gif[具有單一分支樹狀結構的命名空間]
...
image::../media/namespace-architecture-with-multiple-branched-trees.png[具有多個分支樹狀結構的命名空間]
...
image::../media/namespace-architecture-with-multiple-standalone-volumes.gif[具有多個獨立磁碟區的命名空間]
