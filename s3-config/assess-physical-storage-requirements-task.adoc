...
.關於這項工作
在啟用 S3 的 SVM 中建立 S3 儲存桶時，會link:../s3-config/architecture.html#automatic-flexgroup-sizing-with-ontap-9-14-1-and-later["自動建立"]FlexGroup 磁碟區來支援該儲存桶。您可以讓 ONTAP 自動選擇底層 Aggregate 和 FlexGroup 元件（預設設定），也可以手動選擇底層 Aggregate 和 FlexGroup 元件。
...
* https://www.netapp.com/pdf.html?item=/media/17251-tr4571a.pdf["NetApp技術報告4571-A：NetApp ONTAP FlexGroup 《關於NetApp的最新資訊》最佳實務做法"^]
