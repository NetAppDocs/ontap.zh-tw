...
.開始之前
* 您必須是叢集管理員才能執行此工作。
* SnapLock link:https://docs.netapp.com/us-en/ontap/system-admin/install-license-task.html["必須安裝授權"] 在節點上。本授權包含在中 link:https://docs.netapp.com/us-en/ontap/system-admin/manage-licenses-concept.html#licenses-included-with-ontap-one["ONTAP One"]。
