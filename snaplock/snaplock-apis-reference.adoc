...
[role="lead"]
您可以使用Zehyr API、將SnapLock 指令碼或工作流程自動化的功能與功能性功能整合。API使用HTTP、HTTPS和Windows DCE/RPC上的XML訊息。如需詳細資訊，請參閱 link:https://docs.netapp.com/us-en/ontap-automation/["ONTAP 自動化文件"^]。
