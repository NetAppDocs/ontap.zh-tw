...
否
 a| 
是的、從ONTAP 功能性的問題9.8開始。深入瞭解SnapLock 有關xref:FabricPool on支援的資訊。
...
資料量FlexGroup
 a| 
是的、從ONTAP 功能性的問題9.11.1開始。深入瞭解 xref:FlexGroup volumes[支援支援支援功能FlexGroup SnapLock]。
 a| 
是的、從ONTAP 功能性的問題9.11.1開始。深入瞭解 xref:FlexGroup volumes[支援支援支援功能FlexGroup SnapLock]。
...
內部組態MetroCluster
 a| 
是的、從ONTAP 0到3開始。深入瞭解xref:MetroCluster支援。
 a| 
是的、從ONTAP 0到3開始。深入瞭解xref:MetroCluster支援。
